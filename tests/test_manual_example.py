...
def _legacy_potential_file_from_condition(condition: ScatteringCondition) -> str:
    potential_values = _raw_potential_in_input_file_convention(condition)
    ...
    data_lines = [f"({value.real:+.6e}, {value.imag:+.6e})" for value in potential_values]
